...
Route::get('/', [WelcomeController::class, 'welcomeIndex'])->name('index')->middleware('auth');
Route::get('/contact', [WelcomeController::class, 'contactIndex'])->name('contact')->middleware('auth');

Route::get('/ordersClient', [WelcomeController::class, 'ordersIndex'])->name('ordersIndex')->middleware('auth');
...
Route::post('/reparations/view', [OrderController::class, 'storeUser'])->name('order.storeUser');
